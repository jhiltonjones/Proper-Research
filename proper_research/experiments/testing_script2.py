...
try:
    ...
    theta_des =result_user["theta_target_rad"]
    theta_des_abs = abs(result_user["theta_target_rad"])
    length_des = result_user["length_mm"]
    # print(theta_des, length_des)
    if theta_des_abs <np.deg2rad(50) and length_des < 47:
        ...
        B_cmd, phi_cmd, L_cmd, theta_model_deg = jacobian_controller(theta_des_abs, beam_params.B_init, beam_params.phi_init, beam_params.L_init, beam_params.mag, beam_params.A_cs, beam_params.E
