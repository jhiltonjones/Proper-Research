...
# 0.7981328220229531, -0.7112731669220016, 0.17,  np.pi, 0.001,0.001
# ], float)


# start_point = np.array([
# 0.6458941096487977, -0.7112731669220016, 0.17,  np.pi, 0.001,0.001
# ], float)
...
# pivot_point = np.array([
# 0.8281328220229531, -0.6812731669220016, -0.1+0.27,  np.pi, 0.001,0.001
# ], float)
start_point = np.array([
    0.5829653591415975, -0.689259524529552, 0.2715774073392367, -1.679103369649792, 2.6542396815970988, -0.004856187925633785
], float)
pivot_point = start_point
pivot_point[0] = start_point[0]+0.3
# start_point = np.array([
